...
const routes = [
  {
    ...
    children: [
      ...
      { path: 'inputproperty', name: 'inputProperty', component: () => import('pages/admin/InputProperty.vue') },
      { path: 'datauser', name: 'dataUser', component: () => import('pages/admin/DataUser.vue') },
      { path: 'dataproperty', name: 'dataPropertyuas', component: () => import('pages/admin/DataProperty.vue') },
      { path: 'formedit/:id', name: 'formEditProperty', component: () => import('pages/admin/FormEdit.vue') }
    ]
  },
  {
    path: '/user',
