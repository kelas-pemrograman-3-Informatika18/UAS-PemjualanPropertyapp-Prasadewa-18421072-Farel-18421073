        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-cyan-6">
              <div class="text-h6">Data Transaksi Property</div>
              <div >Data Transaksi Pembelian Property</div>
            </q-banner>
          </div>
        </div>
      </div>
        ...
        <template v-slot:body="props">
          <q-tr :props="props">
            <q-td key="judulRumah" :props="props">
              {{ props.row.dataProperty[0].judulRumah }}
            </q-td>
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="text-caption">
                ...
                <div class="text-weight-bold">
                {{ activeData.dataProperty[0].judulRumah }}
                </div>
              </div>
            </div>
            <div class="col">
...
export default {
  ...
  data () {
    return {
      columns: [
        { name: 'judulRumah', align: 'center', label: 'Judul Rumah', field: 'judulRumah', sortable: true },
  ...
  methods: {
    ...
    confirm (id) {
      this.$q.dialog({
        title: 'Konfirmasi',
        message: 'Apakah Anda Yakin Mengkonfirmasi Pembelian?',
        cancel: true,
        persistent: true
      }).onOk(() => {
